...
--CREAR PERSONA
INSERT INTO barbershop.person(created_date_time, role_id, email, last_name, name, phone, document_type,active)VALUES (current_timestamp, 1, 'kevinlazarok23@gmail.com', 'vergel', 'kevin', '123456','Cédula de ciudadania',TRUE);
INSERT INTO barbershop.person(created_date_time, role_id, email, last_name, name, phone, document_type,active)VALUES (current_timestamp, 2, 'ksvergel@gmail.com', 'lazaro', 'santiago', '654321','Cédula de ciudadania',TRUE);
INSERT INTO barbershop.person(created_date_time, role_id, email, last_name, name, phone, document_type,active)VALUES (current_timestamp, 3, 'pepito@gmail.com', 'perez', 'pepe', '112233','Cédula de ciudadania',TRUE);
INSERT INTO barbershop.person(created_date_time, role_id, email, last_name, name, phone, document_type,active)VALUES (current_timestamp, 3, 'aguacate@gmail.com', 'gomez', 'aguacate', '112233','Cédula de ciudadania',TRUE);
